...
{
    public class GuruProfileMap : EntityTypeConfiguration<Teacher>
    {
        public GuruProfileMap()
        {
            // Primary Key
            ...
            this.ToTable("GuruProfiles");
            this.Property(t => t.TeacherId).HasColumnName("GuruId");
