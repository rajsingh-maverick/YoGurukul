...
WebRtcDemo.App = (function (viewModel, connectionManager) {
    var _mediaStream,
        ...
        _callInitiallyToTargetUser = function () {
            var ConnectionId = $('#hdnConnectionID').val();
            _hub.server.answerCall(true, ConnectionId);
            connectionManager.initiateOffer(ConnectionId, _mediaStream);

            // Set UI into call mode
            viewModel.Mode('incall');
            _hub.client.updateUserList = function (userList) {
        ...
        _setupHubCallbacks = function (hub) {
            ...
            hub.client.incomingCall = function (callingUser) {
                ...
                //Edited- Show join button as soon as student gets incoming call
